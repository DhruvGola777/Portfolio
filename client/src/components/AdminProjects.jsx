      ...
      {showForm && (
        <div className="bg-white/5 border border-white/10 p-6 rounded-2xl mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-black/30 border border-white/10 rounded-lg">
              <label className="block text-xs font-medium text-gray-400 mb-2">Case Study Video (.mp4 / .webm)</label>
              <input 
                type="file" 
        ...
        <div className="grid gap-4">
          {projects.length === 0 && (
            <div className="text-center py-12 border border-white/10 border-dashed rounded-2xl bg-white/5">
              ...
              <p className="text-gray-500 text-sm">Click the 'Add Project +' button above to add your first project.</p>
            </div>
          )}
          {projects.map((proj) => (
